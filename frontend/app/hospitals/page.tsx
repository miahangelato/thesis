  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-lg text-gray-700 mb-4 text-center">
        Below is a list of nearby hospitals where you can seek medical assistance.
      </p>
      ...
      <div className="bg-white border rounded-lg shadow-lg p-6">
        ...
        <ul className="list-disc pl-6">
          ...
          <li className="mb-2">
            <strong>Townsville Medical Center</strong> - 202 Elm Street, Townsville
          </li>
          <li className="mb-2">
            <strong>Metropolis Health Institute</strong> - 303 Oak Avenue, Metropolis
          </li>
        </ul>
      </div>
